...
interface ProjectItem {
      ...
      link: string;
      image: string;
      videoUrl?: string; // optional: for future project video demo
}
...
const projectItems: ProjectItem[] = [
      ...
      {
            name: "Fluentype",
            description: "Helps users to improve typing speed while learning English.",
                  ...
                  <div className="flex flex-col items-center justify-center p-4 min-h-screen">
                        ...
                        <main className="max-w-2xl w-full p-6">
                              ...
                              <div className="flex flex-nowrap items-center gap-3 sm:gap-6 mb-6">
                                    <div className="flex-shrink-0 flex items-start pt-8">
                                          <Image
                                                ...
                                                width={90}
                                                height={90}
                                                className="rounded-full object-cover w-[72px] h-[72px] sm:w-[90px] sm:h-[90px]"
                                          />
                                    </div>
                              ...
                              <div className="mb-5 space-y-4 text-left">
                                    ...
                                    <p className={`text-[1.037rem] ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>
                                          I like to read, try, and build new things. Beyond that, I’ve taken part in <span onClick={navigateToHackathons} className="text-blue-600 hover:underline cursor-pointer">hackathons</span> and contributed to <span onClick={navigateToOpenSource} className="text-blue-600 hover:underline cursor-pointer">opensource</span> in the past.
                                    </p>
                              </div>
                                                ...
                                                <div key={index} className="py-2">
                                                      <div className="flex flex-row items-center gap-3 min-h-[36px]">
                                                            <Image
                                                                  ...
                                                                  width={30}
                                                                  height={30}
                                                                  className="object-cover rounded-md w-[30px] h-[30px] align-middle flex-shrink-0"
                                                            />
                                                            <a href={item.link} className="flex-1 min-w-0 block no-underline">
                                                                  <div className="flex flex-col justify-center">
                                                                        <h3 className="text-[15px] font-semibold leading-tight mb-0">{item.name}</h3>
                                                                        <p className="text-[0.97rem] text-gray-500 mt-0.5">{item.description}</p>
                                                                  </div>
                                                            </a>
                                                            <button
                                                                  type="button"
                                                                  onClick={() => toggleExpand(index)}
                                                                  className={`flex items-center flex-shrink-0 p-1.5 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}
                                                      ...
                                                      {expandedItem === index && item.videoUrl && (
                                                            <div className="mt-3 ml-[42px] pl-0">
