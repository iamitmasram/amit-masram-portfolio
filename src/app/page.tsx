          ...
          <div className="flex flex-nowrap items-center gap-2 sm:gap-4 md:gap-6 mb-6">
            <div className="flex-shrink-0 flex items-start pt-4 md:pt-8">
              <Image
                ...
                width={72}
                height={72}
                className="rounded-full object-cover w-[64px] h-[64px] sm:w-[80px] sm:h-[80px] md:w-[96px] md:h-[96px] lg:w-[96px] lg:h-[96px]"
                // Smaller avatar for laptop/tablet, scale up for large screens
              />
            </div>
